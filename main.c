...
void aboutus()
{
   ...
   printf("\n\n\n\n\n");
    for(i=0;i<=100;i++)
    	printf("*");
    printf("\n\t\tThis mini project was designed by Students of 075/BCT'A'\n");
    printf("\t\tAmrit Raj Bista (KAN075BCT006)\n");
    printf("\t\tBibaswan Prasai (KAN075BCT020)\n");
    printf("\t\tMausam Pun      (KAN075BCT034)\n");
    printf("\t\tPiyush Kumar Das(KAN075BCT038)\n");
    for(i=0;i<=100;i++)
    	printf("*");
goto_x_y(45,19);
